...
-   Search anything - Any keywords can be search and scraped from Tiktok.
...
The input of this scraper should be JSON containing the list of pages on Tiktok Search that should be visited. Required fields are:

| Field                | Type    | Description                                                                                                                                                                                                    |
| -------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| search            | Array   | (Optional) List of Tiktok Search keywords. You can type any hashtag in here to search. URLs                                                                                                                 |
| startUrls            | Array   | (Optional) List of Tiktok Search URLs. You should only provide the URLs of search. URLs                                                                                                                 |
...
You can manage the results in any languague (Python, PHP, Node JS/NPM). See the FAQ or <a href="https://www.apify.com/docs/api" target="blank">our API reference</a> to learn more about getting results from this Tiktok Search actor.
