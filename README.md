...
- `search`: (Optional) (String) List of Tiktok Search keywords. You can type any hashtag in here to search.

- `startUrls`: (Optional) (Array) List of Tiktok Search URLs. You should only provide the URLs of search. URLs.
